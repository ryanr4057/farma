...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference("Medicamento.count") do
      post medicamentos_url, params: { medicamento: { bula: @medicamento.bula, nome: @medicamento.nome, preco: @medicamento.preco } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { bula: @medicamento.bula, nome: @medicamento.nome, preco: @medicamento.preco } }
